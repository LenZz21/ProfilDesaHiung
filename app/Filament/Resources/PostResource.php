...
class PostResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\FileUpload::make('thumbnail')->label('Gambar Utama')->image()->disk(config('filesystems.default'))->directory('posts')->visibility('public')->fetchFileInformation(false),
