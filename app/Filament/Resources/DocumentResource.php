...
class DocumentResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\FileUpload::make('file')->label('Berkas')->disk(config('filesystems.default'))->directory('documents')->visibility('public')->fetchFileInformation(false)->required(),
